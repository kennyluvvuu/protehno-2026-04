...
director123
```
Данные от пользователей: почта указана на платформе директора, пароль - mango user id из платформы директора
...
- [Mango integration guide](/docs/integrations/mango.md)
- [CRM / Service API guide](/docs/crm-api.md)
