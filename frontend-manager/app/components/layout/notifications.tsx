    ...
    return (
        <div
            className={cn(
                ...
                n.isRead ? "opacity-50" : "bg-neutral-50 dark:bg-neutral-800/60",
            )}
        >
...
function NotificationsModal({
    ...
    return (
        <Dialog open={open} onOpenChange={(value) => !value && onClose()}>
            <DialogContent className="w-[min(520px,calc(100%-2rem))] max-w-none gap-0 p-0 [&>button:last-child]:hidden">
                <DialogHeader className="flex flex-row items-center justify-between border-b border-neutral-200 px-5 py-4 dark:border-neutral-800">
        ...
        <>
            <div className="relative" ref={containerRef}>
                ...
                >
                    ...
                    {unreadCount > 0 && (
                        <span className="absolute -right-0.5 -top-0.5 flex h-4 min-w-[16px] items-center justify-center rounded-full bg-neutral-800 px-1 text-[10px] font-medium leading-none text-white dark:bg-neutral-200 dark:text-neutral-900">
                            {unreadCount}
                        </span>
                    )}
                </button>
